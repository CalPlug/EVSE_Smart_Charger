...
[num,txt,raw] = xlsread('AvailablePower.xlsx','C2:C25');
elseif strcmp(season,'Spring')==1
[num,txt,raw] = xlsread('AvailablePower.xlsx','C27:C50');
elseif strcmp(season,'Summer')==1
[num,txt,raw] = xlsread('AvailablePower.xlsx','C52:C75');
else
[num,txt,raw] = xlsread('AvailablePower.xlsx','C77:C100');
end
%*******************************************************************%
